...
Image.MAX_IMAGE_PIXELS = None ## fixed pixels could be decompression bomb DOS attack
...
## data
_PREDEFINED_SPLITS = {
    "entityv3_entity_train_01": (
        "EntitySAM/images/images/entity_01_11580",
        "EntitySAM/annotations/entityseg_train_01_fixed.json"
    ),
    "entityv3_entity_train_02": (
        "EntitySAM/images/images/entity_02_11598",
        "EntitySAM/annotations/entityseg_train_02.json"
    ),
    "entityv3_entity_train_03": (
        "EntitySAM/images/images/entity_03_10049",
        "EntitySAM/annotations/entityseg_train_03.json"
    ),
    "entityv3_entity_train_all": (
        "EntitySAM/images",
        "EntitySAM/annotations/entityseg_train.json"
    ),
    "entityv3_entity_val_all": (
        "EntitySAM/images",
        "EntitySAM/annotations/entityseg_val.json"
    ),
    "entityv3_entity_train_all_lr": (
        "EntitySAM/images_lr",
        "EntitySAM/annotations/entityseg_train_lr.json"
    ),
    "entityv3_entity_val_all_lr": (
        "EntitySAM/images/imageslr",
        "EntitySAM/annotations/entityseg_val_lr.json"
    ),
    "entityv3_entity_val": (
        "EntitySAM/images/images",
        "EntitySAM/annotations/entityseg_val.json"
    ),
    "entityv3_air_train": (
        "EntitySAM/images/images",
...
## [fixed]
_PREDEFINED_SPLITS_COCO["coco_2017_train_entity_rle_v2"] = ("./dataset/coco/train2017", "./dataset/coco/entity_train2017.json")
...
_root = os.getenv("DETECTRON2_DATASETS", "/data/xxxx/")
